...
{
    public partial class cost_grp : System.Web.UI.Page
    {
        ...
        public void OnLoad()
        {
            //Execute pr_lst_items(‘costs’, @tour_id) which returns two recordsets. The first is single_row recordset with the following column: 1. tour_descr. Use this value to populate div_tour_info. 
            //● The second recordset is a multiple row recordset with the following columns. Use this information to create the data grid in select_contract, each item having an onclick action of dtlCost(). 
            ...
            {
                div_tour_info.Text = ds.Tables[0].Rows[0]["tour_descr"].ToString();
            }
        ...
        {
            //After confirmation, execute pr_del_item(‘cost’, @cost_id, @emp_id) which returns 1 if successful, 0 if failure. 
            //● Call resetForm() ● Execute pr_list_items(‘costs’, @tour_id) as shown in onLoad() below
            try
            {
        ...
        public void setCost(object sender, EventArgs e)
        {
            ...
            //● After validation completion, execute pr_set_item(‘cost’, @tour_id, @emp_id, @cost_id, @category_id, @cost_descr, @cost_amt, @pmt_per_id) which returns 1 if successful, 0 if failure. 
        ...
        public void dtlCost()
        {
            ...
            try
            {
                ...
                obj.mode = "cost";
                obj.id1 = OPS_cost_id.Value.ToString();
                DataTable dt = DTL_ITEM_Business.GetItemDetails(obj).Tables[0];
