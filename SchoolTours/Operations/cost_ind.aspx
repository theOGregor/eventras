<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cost_ind.aspx.cs" Inherits="SchoolTours.Operations.cost_ind" %>
                ...
                <div class="card bg-primary h-100 mb-0 overflow-hidden">
                    <div class="card-header bg-blue">
                        <h6 class="my-0 text-white">
                            ...
                            <asp:DropDownList ID="select_pax" runat="server" class="custom-select custom-select-sm float-right w-25" AutoPostBack="true" OnSelectedIndexChanged="select_pax_SelectedIndexChanged"></asp:DropDownList>
                        </h6>
                                    ...
                                    <div class="form-row h-100 position-relative align-content-start">
                                        ...
                                        <div class="w-100 form-row d-flex align-items-end position-relative mt-2">
                                            ...
                                            <div class="col-md-8 mt-3 text-right">
                                                <a href="javascript:void(0);" class="d-inline-block float-left" onclick="javascript:shwMod();">
                                                    <img src="../Content/images/icon_info.png" alt="" width="30" title="Info">
