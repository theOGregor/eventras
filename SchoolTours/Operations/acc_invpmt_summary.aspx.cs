...
{
    public partial class acc_invpmt_summary : System.Web.UI.Page
    {
        ...
        public void prnEvt(object sender, EventArgs e)
        {
            ...
            SB.Append("<th style=\"border:1px solid;\">PPA</th>");
            SB.Append("<th style=\"border:1px solid;\">Inv to Date</th>");
            SB.Append("<th style=\"border:1px solid;\">Next Inv Date</th>");
            SB.Append("<th style=\"border:1px solid;\">Next Inv Amt</th>");
            SB.Append("<th style=\"border:1px solid;\">Paid to Date</th>");
            SB.Append("<th style=\"border:1px solid;\">Past Due</th>");
            SB.Append("<th style=\"border:1px solid;\">FIN</th>");
            SB.Append("</tr>");
            SB.Append("</thead>");
            SB.Append("<tbody>");
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                SB.Append("<td style=\"border:1px solid;\">" + dt.Rows[i]["ppa_ind"].ToString() + "</td>");
                SB.Append("<td style=\"border:1px solid;\">$ " + String.Format("{0:0.00}", Convert.ToDecimal(dt.Rows[i]["total_inv"].ToString())) + "</td>");
                SB.Append("<td style=\"border:1px solid;\">" + dt.Rows[i]["inv_date"].ToString() + "</td>");
                SB.Append("<td style=\"border:1px solid;\">" + dt.Rows[i]["inv_descr"].ToString() + "</td>");
                SB.Append("<td style=\"border:1px solid;\">$ " + String.Format("{0:0.00}", Convert.ToDecimal(dt.Rows[i]["total_paid"].ToString())) + "</td>");
                SB.Append("<td style=\"border:1px solid;\">$ " + String.Format("{0:0.00}", Convert.ToDecimal(dt.Rows[i]["total_past_due"].ToString())) + "</td>");
                SB.Append("<td style=\"border:1px solid;\">" + dt.Rows[i]["fin_ind"].ToString() + "</td>");
                SB.Append("</tr>");
            }
            SB.Append("</tbody>");
            SB.Append("</table>");
            ...
            try
            {
                string File_name = "Inv_pay_summary.pdf";
