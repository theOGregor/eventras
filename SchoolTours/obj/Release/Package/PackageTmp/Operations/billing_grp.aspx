<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="billing_grp.aspx.cs" Inherits="SchoolTours.Operations.billing_grp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="main pt-4">
        ...
        <asp:HiddenField ID="OPS_pax_nr" runat="server" />
                ...
                <div class="card bg-primary h-100 mb-0 overflow-hidden">
                    <div class="card-header bg-blue">
                        <h6 class="mb-0 text-white">
                            ...
                            <asp:Button ID="input_pax_nr" runat="server" Class="form-control float-right" OnClick="setPaxNr" Text="Pax" Style="width: 10%;"></asp:Button>
                            <%--<asp:DropDownList ID="custom-select custom-select-sm float-right w-25" runat="server" OnSelectedIndexChanged="dtlPax" AutoPostBack="true"></asp:DropDownList>--%>
                        </h6>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-row h-100 position-relative align-content-start">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <asp:ListBox ID="div_reminder" Visible="false" runat="server" class="list-unstyled mb-0 p-2 w-100 bg-light-blue mb-2 border-rad h-75"></asp:ListBox>
                                        </div>
                                        <div class="col-md-12 mt-3 bot-fix text-right">
                                            <a href="javascript:void(0);" class="d-inline-block">
                                                <asp:ImageButton ID="img_mail_inv" runat="server" ImageUrl="../Content/images/icon_mail.png" alt="" Width="30" OnClick="img_mail_inv_Click" title="Mail" OnClientClick="showProgress();" />
                                            </a>
                                            <a href="javascript:void(0);" class="d-inline-block">
                                                <%-- <img src="images/icon_print.png" alt="" width="30">--%>
                                                <asp:ImageButton ID="img_print_inv" runat="server" ImageUrl="../Content/images/icon_print.png" alt="" Width="30" OnClick="img_print_inv_Click" title="Print" OnClientClick="showProgress();" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
