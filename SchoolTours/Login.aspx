<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SchoolTours.Login" %>
...
<body class="d-flex align-items-center justify-content-center">
    <form id="form1" runat="server" class="form-signin">
        ...
        <div class="div_minimizer2_logo">
            <img class="img-fluid" src="Content/images/mimizer-2-logo.png" alt="minimizer" />
        ...
        <div class="col-md-8 ml-auto">
            <div class="div_error_msg text-center">
                ...
                <asp:Label ID="lbl_error_msg" runat="server" Text="" Style="color: red;"></asp:Label>
                    </p>
            </div>
